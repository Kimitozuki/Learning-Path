...
public class Java_46_Array_Multi_D_pt2 {
    public static void main(String[] args) {
        int[][] array_2D = {{1,2,3}, {4,5},};
        //Print biasa hanya akan mengeluarkan alamat array saja
        ...
        //Sintak yg digunakan untuk print array multi dimensi
